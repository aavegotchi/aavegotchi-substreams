    ...
    pub mod functions {
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct ClaimInstallations {
            pub queue_ids: Vec<substreams::scalar::BigInt>,
        }
        impl ClaimInstallations {
            const METHOD_ID: [u8; 4] = [118u8, 59u8, 148u8, 138u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for ClaimInstallations {
            const NAME: &'static str = "claimInstallations";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct CraftInstallations {
            pub installation_types: Vec<substreams::scalar::BigInt>,
            pub gltr: Vec<substreams::scalar::BigInt>,
        }
        impl CraftInstallations {
            const METHOD_ID: [u8; 4] = [159u8, 242u8, 165u8, 39u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for CraftInstallations {
            const NAME: &'static str = "craftInstallations";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct DeleteBuggedUpgrades {
            pub parcel_id: substreams::scalar::BigInt,
            pub coordinate_x: substreams::scalar::BigInt,
            pub coordinate_y: substreams::scalar::BigInt,
            pub installation_id: substreams::scalar::BigInt,
            pub upgrade_index: substreams::scalar::BigInt,
        }
        impl DeleteBuggedUpgrades {
            const METHOD_ID: [u8; 4] = [159u8, 208u8, 120u8, 40u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                self.parcel_id.clone().to_signed_bytes_be().as_slice(),
                            ),
                        ),
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                self.coordinate_x.clone().to_signed_bytes_be().as_slice(),
                            ),
                        ),
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                self.coordinate_y.clone().to_signed_bytes_be().as_slice(),
                            ),
                        ),
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                self.installation_id.clone().to_signed_bytes_be().as_slice(),
                            ),
                        ),
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                self.upgrade_index.clone().to_signed_bytes_be().as_slice(),
                            ),
                        ),
                    ],
                );
        ...
        impl substreams_ethereum::Function for DeleteBuggedUpgrades {
            const NAME: &'static str = "deleteBuggedUpgrades";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct DeprecateInstallations {
            pub installation_ids: Vec<substreams::scalar::BigInt>,
        }
        impl DeprecateInstallations {
            const METHOD_ID: [u8; 4] = [204u8, 182u8, 7u8, 39u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for DeprecateInstallations {
            const NAME: &'static str = "deprecateInstallations";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        pub struct EditDeprecateTime {
            ...
            pub deprecate_time: substreams::scalar::BigInt,
        }
        impl EditDeprecateTime {
            const METHOD_ID: [u8; 4] = [0u8, 21u8, 201u8, 59u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                self.type_id.clone().to_signed_bytes_be().as_slice(),
                            ),
                        ),
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                self.deprecate_time.clone().to_signed_bytes_be().as_slice(),
                            ),
                        ),
                    ],
                );
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct EditInstallationUnequipTypes {
            pub ids: Vec<substreams::scalar::BigInt>,
            pub unequip_types: Vec<substreams::scalar::BigInt>,
        }
        impl EditInstallationUnequipTypes {
            const METHOD_ID: [u8; 4] = [73u8, 59u8, 53u8, 111u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for EditInstallationUnequipTypes {
            const NAME: &'static str = "editInstallationUnequipTypes";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        pub struct EquipInstallation {
            pub owner: Vec<u8>,
            pub realm_id: substreams::scalar::BigInt,
            pub installation_id: substreams::scalar::BigInt,
        }
        impl EquipInstallation {
            const METHOD_ID: [u8; 4] = [100u8, 229u8, 183u8, 169u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                self.realm_id.clone().to_signed_bytes_be().as_slice(),
                            ),
                        ),
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct FinalizeUpgrades {
            pub upgrade_indexes: Vec<substreams::scalar::BigInt>,
        }
        impl FinalizeUpgrades {
            const METHOD_ID: [u8; 4] = [73u8, 110u8, 109u8, 85u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for FinalizeUpgrades {
            const NAME: &'static str = "finalizeUpgrades";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl GetAddresses {
            const METHOD_ID: [u8; 4] = [163u8, 159u8, 172u8, 18u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetAddresses {
            const NAME: &'static str = "getAddresses";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetAltarLevel {
            pub altar_id: substreams::scalar::BigInt,
        }
        impl GetAltarLevel {
            const METHOD_ID: [u8; 4] = [62u8, 152u8, 221u8, 108u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                self.altar_id.clone().to_signed_bytes_be().as_slice(),
                            ),
                        ),
                    ],
                );
        ...
        impl substreams_ethereum::Function for GetAltarLevel {
            const NAME: &'static str = "getAltarLevel";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetInstallationUnequipType {
            pub installation_id: substreams::scalar::BigInt,
        }
        impl GetInstallationUnequipType {
            const METHOD_ID: [u8; 4] = [46u8, 172u8, 112u8, 34u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GetInstallationUnequipType {
            const NAME: &'static str = "getInstallationUnequipType";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
        for GetInstallationUnequipType {
            fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
                Self::output(data)
            }
        }
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetLodgeLevel {
            pub installation_id: substreams::scalar::BigInt,
        }
        impl GetLodgeLevel {
            const METHOD_ID: [u8; 4] = [128u8, 71u8, 242u8, 206u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GetLodgeLevel {
            const NAME: &'static str = "getLodgeLevel";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetReservoirCapacity {
            pub installation_id: substreams::scalar::BigInt,
        }
        impl GetReservoirCapacity {
            const METHOD_ID: [u8; 4] = [211u8, 96u8, 98u8, 73u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GetReservoirCapacity {
            const NAME: &'static str = "getReservoirCapacity";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
        for GetReservoirCapacity {
            fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
                Self::output(data)
            }
        }
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetUpgradeQueueLength {}
        impl GetUpgradeQueueLength {
            const METHOD_ID: [u8; 4] = [159u8, 157u8, 87u8, 249u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for GetUpgradeQueueLength {
            const NAME: &'static str = "getUpgradeQueueLength";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
        for GetUpgradeQueueLength {
            fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
                Self::output(data)
            }
        }
        #[derive(Debug, Clone, PartialEq)]
        pub struct InstallationBalancesOfTokenByIds {
            pub token_contract: Vec<u8>,
            pub token_id: substreams::scalar::BigInt,
            pub ids: Vec<substreams::scalar::BigInt>,
        }
        impl InstallationBalancesOfTokenByIds {
            const METHOD_ID: [u8; 4] = [191u8, 8u8, 6u8, 186u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for InstallationBalancesOfTokenByIds {
            const NAME: &'static str = "installationBalancesOfTokenByIds";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<substreams::scalar::BigInt>>
        for InstallationBalancesOfTokenByIds {
            fn output(data: &[u8]) -> Result<Vec<substreams::scalar::BigInt>, String> {
                Self::output(data)
            }
        }
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct MintInstallations {
            pub installation_ids: Vec<substreams::scalar::BigInt>,
            pub amounts: Vec<substreams::scalar::BigInt>,
            pub to_address: Vec<u8>,
        }
        impl MintInstallations {
            const METHOD_ID: [u8; 4] = [227u8, 207u8, 118u8, 123u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.to_address),
                        ),
                    ],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
        ...
        impl substreams_ethereum::Function for MintInstallations {
            const NAME: &'static str = "mintInstallations";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct MockCraftInstallation {
            pub installation_id: substreams::scalar::BigInt,
        }
        impl MockCraftInstallation {
            const METHOD_ID: [u8; 4] = [225u8, 84u8, 141u8, 22u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for MockCraftInstallation {
            const NAME: &'static str = "mockCraftInstallation";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct MockGetInstallationsLength {}
        impl MockGetInstallationsLength {
            const METHOD_ID: [u8; 4] = [143u8, 235u8, 52u8, 193u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for MockGetInstallationsLength {
            const NAME: &'static str = "mockGetInstallationsLength";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
        for MockGetInstallationsLength {
            fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
                Self::output(data)
            }
        }
        #[derive(Debug, Clone, PartialEq)]
        pub struct ParcelInstallationUpgrading {
            pub parcel_id: substreams::scalar::BigInt,
            pub installation_id: substreams::scalar::BigInt,
            pub x: substreams::scalar::BigInt,
            pub y: substreams::scalar::BigInt,
        }
        impl ParcelInstallationUpgrading {
            const METHOD_ID: [u8; 4] = [105u8, 183u8, 86u8, 10u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                self.x.clone().to_signed_bytes_be().as_slice(),
                            ),
                        ),
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                self.y.clone().to_signed_bytes_be().as_slice(),
                            ),
                        ),
                    ],
                );
        ...
        impl substreams_ethereum::Function for ParcelInstallationUpgrading {
            const NAME: &'static str = "parcelInstallationUpgrading";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        for ParcelInstallationUpgrading {
            fn output(data: &[u8]) -> Result<bool, String> {
                Self::output(data)
            }
        }
        #[derive(Debug, Clone, PartialEq)]
        pub struct ParcelQueueEmpty {
            pub parcel_id: substreams::scalar::BigInt,
        }
        impl ParcelQueueEmpty {
            const METHOD_ID: [u8; 4] = [121u8, 139u8, 255u8, 30u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for ParcelQueueEmpty {
            const NAME: &'static str = "parcelQueueEmpty";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<bool> for ParcelQueueEmpty {
            fn output(data: &[u8]) -> Result<bool, String> {
                Self::output(data)
            }
        }
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct ReduceUpgradeTime {
            pub upgrade_index: substreams::scalar::BigInt,
            pub gotchi_id: substreams::scalar::BigInt,
            pub blocks: substreams::scalar::BigInt,
            pub signature: Vec<u8>,
        }
        impl ReduceUpgradeTime {
            const METHOD_ID: [u8; 4] = [97u8, 120u8, 141u8, 3u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                self.gotchi_id.clone().to_signed_bytes_be().as_slice(),
                            ),
                        ),
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
        ...
        impl substreams_ethereum::Function for ReduceUpgradeTime {
            const NAME: &'static str = "reduceUpgradeTime";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl SetAddresses {
            const METHOD_ID: [u8; 4] = [74u8, 23u8, 16u8, 84u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct SpilloverRateAndRadiusOfId {
            pub id: substreams::scalar::BigInt,
        }
        impl SpilloverRateAndRadiusOfId {
            const METHOD_ID: [u8; 4] = [188u8, 93u8, 37u8, 34u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for SpilloverRateAndRadiusOfId {
            const NAME: &'static str = "spilloverRateAndRadiusOfId";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<
            (substreams::scalar::BigInt, substreams::scalar::BigInt),
        > for SpilloverRateAndRadiusOfId {
            fn output(
                data: &[u8],
            ) -> Result<
                (substreams::scalar::BigInt, substreams::scalar::BigInt),
        ...
        impl UnequipInstallation {
            const METHOD_ID: [u8; 4] = [236u8, 211u8, 34u8, 69u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        pub struct UpgradeComplete {
            pub queue_id: substreams::scalar::BigInt,
        }
        impl UpgradeComplete {
            const METHOD_ID: [u8; 4] = [101u8, 98u8, 231u8, 14u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                self.queue_id.clone().to_signed_bytes_be().as_slice(),
                            ),
                        ),
                    ],
                );
        ...
        impl substreams_ethereum::Function for UpgradeComplete {
            const NAME: &'static str = "upgradeComplete";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<bool> for UpgradeComplete {
            fn output(data: &[u8]) -> Result<bool, String> {
                Self::output(data)
            }
        }
    ...
    pub mod events {
        use super::INTERNAL_ERR;
        #[derive(Debug, Clone, PartialEq)]
        pub struct AddInstallationType {
            pub installation_id: substreams::scalar::BigInt,
        }
        impl AddInstallationType {
        ...
        impl substreams_ethereum::Event for AddInstallationType {
            const NAME: &'static str = "AddInstallationType";
        ...
        pub struct AddedToQueue {
            pub queue_id: substreams::scalar::BigInt,
            pub installation_id: substreams::scalar::BigInt,
            pub ready_block: substreams::scalar::BigInt,
            pub sender: Vec<u8>,
        }
        impl AddedToQueue {
            const TOPIC_ID: [u8; 32] = [
        ...
        pub struct AlchemicaClaimed1 {
            pub realm_id: substreams::scalar::BigInt,
            pub gotchi_id: substreams::scalar::BigInt,
            pub alchemica_type: substreams::scalar::BigInt,
            pub amount: substreams::scalar::BigInt,
            pub spillover_rate: substreams::scalar::BigInt,
            pub spillover_radius: substreams::scalar::BigInt,
        }
        ...
        pub struct CraftTimeReduced {
            pub queue_id: substreams::scalar::BigInt,
            pub blocks_reduced: substreams::scalar::BigInt,
        }
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct DeprecateInstallation {
            pub installation_id: substreams::scalar::BigInt,
        }
        impl DeprecateInstallation {
            const TOPIC_ID: [u8; 32] = [
                55u8,
                6u8,
                255u8,
        ...
        impl substreams_ethereum::Event for DeprecateInstallation {
            const NAME: &'static str = "DeprecateInstallation";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct EditInstallationType {
            pub installation_id: substreams::scalar::BigInt,
        }
        impl EditInstallationType {
            const TOPIC_ID: [u8; 32] = [
                129u8,
                190u8,
                165u8,
        ...
        impl substreams_ethereum::Event for EditInstallationType {
            const NAME: &'static str = "EditInstallationType";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct EditInstallationUnequipType {
            pub installation_id: substreams::scalar::BigInt,
        }
        impl EditInstallationUnequipType {
            const TOPIC_ID: [u8; 32] = [
                120u8,
                86u8,
                169u8,
        ...
        impl substreams_ethereum::Event for EditInstallationUnequipType {
            const NAME: &'static str = "EditInstallationUnequipType";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        pub struct MintInstallation1 {
            pub owner: Vec<u8>,
            pub installation_type: substreams::scalar::BigInt,
            pub installation_id: substreams::scalar::BigInt,
        }
        ...
        pub struct MintTile1 {
            pub owner: Vec<u8>,
            pub tile_type: substreams::scalar::BigInt,
            pub tile_id: substreams::scalar::BigInt,
        }
        impl MintTile1 {
            const TOPIC_ID: [u8; 32] = [
                81u8,
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct SetInstallationUnequipType {
            pub installation_id: substreams::scalar::BigInt,
            pub unequip_type: substreams::scalar::BigInt,
        }
        impl SetInstallationUnequipType {
            const TOPIC_ID: [u8; 32] = [
                234u8,
                222u8,
                14u8,
        ...
        impl substreams_ethereum::Event for SetInstallationUnequipType {
            const NAME: &'static str = "SetInstallationUnequipType";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        pub struct SurveyParcel1 {
            ...
            pub alchemicas: Vec<substreams::scalar::BigInt>,
        }
        impl SurveyParcel1 {
            const TOPIC_ID: [u8; 32] = [
                97u8,
        ...
        impl substreams_ethereum::Event for UpgradeCancelled {
            const NAME: &'static str = "UpgradeCancelled";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        pub struct UpgradeFinalized1 {
            ...
            pub coordinate_x: substreams::scalar::BigInt,
            pub coordinate_y: substreams::scalar::BigInt,
            pub new_installation_id: substreams::scalar::BigInt,
        }
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct UpgradeFinalized3 {
            pub realm_id: substreams::scalar::BigInt,
            pub coordinate_x: substreams::scalar::BigInt,
            pub coordinate_y: substreams::scalar::BigInt,
            pub new_installation_id: substreams::scalar::BigInt,
        }
        impl UpgradeFinalized3 {
            const TOPIC_ID: [u8; 32] = [
                226u8,
                228u8,
                179u8,
        ...
        impl substreams_ethereum::Event for UpgradeFinalized3 {
            const NAME: &'static str = "UpgradeFinalized3";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        pub struct UpgradeInitiated1 {
            ...
            pub coordinate_x: substreams::scalar::BigInt,
            pub coordinate_y: substreams::scalar::BigInt,
            pub block_initiated: substreams::scalar::BigInt,
            pub ready_block: substreams::scalar::BigInt,
            pub installation_id: substreams::scalar::BigInt,
        }
        ...
        impl substreams_ethereum::Event for UpgradeInitiated3 {
            const NAME: &'static str = "UpgradeInitiated3";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        pub struct UpgradeQueueFinalized1 {
            pub owner: Vec<u8>,
            pub realm_id: substreams::scalar::BigInt,
            pub queue_index: substreams::scalar::BigInt,
        }
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct UpgradeQueueFinalized3 {
            pub owner: Vec<u8>,
            pub realm_id: substreams::scalar::BigInt,
            pub queue_index: substreams::scalar::BigInt,
        }
        impl UpgradeQueueFinalized3 {
            const TOPIC_ID: [u8; 32] = [
                182u8,
                138u8,
                183u8,
        ...
        impl substreams_ethereum::Event for UpgradeQueueFinalized3 {
            const NAME: &'static str = "UpgradeQueueFinalized3";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        impl substreams_ethereum::Event for UpgradeQueued3 {
            const NAME: &'static str = "UpgradeQueued3";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct UpgradeTimeReduced1 {
            pub queue_id: substreams::scalar::BigInt,
            pub realm_id: substreams::scalar::BigInt,
            pub coordinate_x: substreams::scalar::BigInt,
            pub coordinate_y: substreams::scalar::BigInt,
        ...
        impl substreams_ethereum::Event for UpgradeTimeReduced1 {
            const NAME: &'static str = "UpgradeTimeReduced1";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct UpgradeTimeReduced2 {
            pub queue_id: substreams::scalar::BigInt,
            pub realm_id: substreams::scalar::BigInt,
            pub coordinate_x: substreams::scalar::BigInt,
            pub coordinate_y: substreams::scalar::BigInt,
        ...
        impl substreams_ethereum::Event for UpgradeTimeReduced2 {
            const NAME: &'static str = "UpgradeTimeReduced2";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct UpgradeTimeReduced3 {
            pub queue_id: substreams::scalar::BigInt,
            pub realm_id: substreams::scalar::BigInt,
            pub coordinate_x: substreams::scalar::BigInt,
            pub coordinate_y: substreams::scalar::BigInt,
        ...
        impl substreams_ethereum::Event for UpgradeTimeReduced3 {
            const NAME: &'static str = "UpgradeTimeReduced3";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
